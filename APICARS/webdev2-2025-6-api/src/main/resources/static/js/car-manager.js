// API Configuration - Using relative paths for Spring Boot integration
...
class CarManager {
    ...
    async handleFormSubmit(e) {
        ...
        if (carData.year < 1900 || carData.year > 2025) {
            this.showError('Year must be between 1900 and 2025.');
            return;
        }
        ...
        try {
            ...
            if (error.message.includes('400')) {
                this.showError('Please check your input. All fields are required and year must be between 1900-2025.');
            } else {
